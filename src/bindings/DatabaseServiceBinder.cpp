...
template <>
const char *PythonStruct<DatabaseProgressMsg>::msName = "DatabaseProgressMsg";
...
typedef PythonCallback<DatabaseProgressMsg,
                       PythonDatabaseProgressMessageConverter>
    PythonDatabaseProgressCallback;
typedef shared_ptr<PythonDatabaseProgressCallback>
    PythonDatabaseProgressCallbackPtr;
...
const char *darkness_DatabaseService_load__doc__ =
    ...
    "@param mask: The mask to use while loading (see the DBM_ constants for "
    "more info)\n"
...
PyObject *DatabaseServiceBinder::load(PyObject *self, PyObject *args) {
    ...
    if (PyArg_ParseTuple(args, "si", &fname, &mask)) {
        ...
        PyErr_SetString(PyExc_TypeError,
                        "Expected a string and integer arguments!");
        return NULL;
    }
...
// ------------------------------------------
PyObject *DatabaseServiceBinder::recursiveMergeLoad(PyObject *self,
                                                    PyObject *args) {
    __PYTHON_EXCEPTION_GUARD_BEGIN_;
...
// ------------------------------------------
PyObject *DatabaseServiceBinder::setProgressListener(PyObject *self,
                                                     PyObject *args) {
    __PYTHON_EXCEPTION_GUARD_BEGIN_;
...
// ------------------------------------------
PyObject *DatabaseServiceBinder::unsetProgressListener(PyObject *self,
                                                       PyObject *args) {
    __PYTHON_EXCEPTION_GUARD_BEGIN_;
...
void DatabaseServiceBinder::init(PyObject *module) {
    ...
    PyModule_AddIntConstant(module, "DBM_OBJTREE_CONCRETE",
                            DBM_OBJTREE_CONCRETE);
