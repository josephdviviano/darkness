...
const char *darkness_PropertyService_getPropertyFieldsDesc__doc__ =
    ...
    "@param name: Property name\n"
    "@rtype: iterable object\n"
    "@return: Returns iterable object containing all properties field names as "
    "data field description iterator\n";
...
PyObject *PropertyServiceBinder::get(PyObject *self, PyObject *args) {
    ...
    if (PyArg_ParseTuple(args, "iss", &obj_id, &propName, &propField)) {
        ...
        // Invalid parameters
        PyErr_SetString(PyExc_TypeError,
                        "Expected an integer and two strings!");
        return NULL;
    }
    __PYTHON_EXCEPTION_GUARD_END_;
}
...
// ------------------------------------------
PyObject *PropertyServiceBinder::getAllPropertyNames(PyObject *self,
                                                     PyObject *args) {
    __PYTHON_EXCEPTION_GUARD_BEGIN_;
    PropertyServicePtr o;
...
// ------------------------------------------
PyObject *PropertyServiceBinder::getPropertyFieldsDesc(PyObject *self,
                                                       PyObject *args) {
    __PYTHON_EXCEPTION_GUARD_BEGIN_;
    PropertyServicePtr o;
