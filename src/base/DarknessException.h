...
public:
    /** Constructor. */
    BasicException(const std::string &desc, const std::string &src,
                   const char *file = NULL, long line = -1);
...
public:
    IndexOutOfBoundsException(const std::string &txt, const char *file = NULL,
                              long line = -1)
