...
/*	struct DarkDBRoom
        {
                ...
                DVector3  center;         // should not be in solid space or
   overlapping another room DPlane    plane[6]; uint32_t  num_portals;
                //DarkDBRoomPortal portals[]
                // A matrix of portal-to-portal distances, calculated as the
   linear distance
                // between each pair of portal centers.
                //float distances[] // num_portals**2
                //uint32        num_lists // The number of count+arrays that
   follow. Usually 2.
                //DarkDBIDList lists[]
                ...
                // (The IDs should be in both lists, unless you know of an AI
   that isn't an object.)
        ...
        struct DarkDBRoomPortal
        {
                ...
                uint32_t  index;          // The index of this portal in the
   room's portal list DPlane    plane; uint32_t  num_edges;
                ...
                DVector3  center;         // center point of the portal. (should
   not be in solid space) sint32_t  dest_portal;    // portal ID on the other
   side of this portal
