...
SimListener::SimListener()
    : mSimTime(0), mSimTimeFlow(1), mSimPaused(false), mSimRunning(false) {}
...
//------------------------------------------------------
void SimListener::simEnded() { mSimRunning = false; }

//------------------------------------------------------
void SimListener::simPaused() { mSimPaused = true; }

//------------------------------------------------------
void SimListener::simUnPaused() { mSimPaused = false; }

//------------------------------------------------------
void SimListener::simFlowChange(float newFlow) { mSimTimeFlow = newFlow; }

//------------------------------------------------------
void SimListener::simStep(float simTime, float delta) { mSimTime = simTime; }
...
const std::string &SimServiceFactory::getName() { return mName; }

const uint SimServiceFactory::getMask() { return SERVICE_ENGINE; }

const size_t SimServiceFactory::getSID() { return SimService::SID; }
