...
// ── Camera cell detection + point-in-polygon ──
// findCameraCell, getCameraMediaType, pointInConvexPolygon are in CellGeometry.h
// (extracted for bgfx-free reuse by RayCaster.h and tests)
