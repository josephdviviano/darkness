...
static void printHelp() {
    ...
    std::fprintf(stderr,
        ...
        "                    (rays=4096 bounces=8 diffuse=256, ~32x cheaper\n"
        "                    per probe than ship yaml settings). Cached\n"
        "                    .probes from a dev bake are DEV QUALITY — re-bake\n"
        "                    without it for milestone reverb fidelity.\n"
